...
/**
 * Retrofit-kx need to know default error format.
 *
 * Use this annotation to specify which format this default error should have.
 *
 * Like this:
 * ```
 * @RetrofitError
 ...
 *
 * See [Remote] on how to override error per service
 */
@MustBeDocumented
@Target(AnnotationTarget.CLASS)
annotation class RetrofitError
