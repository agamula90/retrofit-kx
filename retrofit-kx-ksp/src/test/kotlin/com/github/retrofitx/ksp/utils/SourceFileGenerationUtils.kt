package com.github.retrofitx.ksp.utils

import com.tschuchort.compiletesting.KotlinCompilation
import com.github.retrofitx.ksp.BASE_PACKAGE
import okhttp3.*
...
fun getDefaultDataTransferObjects() = """
    package com.github.retrofitx.test.dto
...
fun String.getDefaultService() = """
    ...
    import com.github.retrofitx.test.dto.SignInRequest
    import com.github.retrofitx.test.dto.SignUpRequest
    import com.github.retrofitx.test.dto.UserDTO
...
fun KotlinCompilation.Result.getErrorClass(): KClass<out Any> {
    return classLoader.loadClass("com.github.retrofitx.test.dto.Error").kotlin
}
